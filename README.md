...
DUFFEL_API_TOKEN=<duffel-test-key>
# Backwards compatibility fallback
DUFFEL_ACCESS_TOKEN=<duffel-test-key>
...
# Optional: disable auth UI/session requirement for local demos
...
If `NEXT_PUBLIC_DISABLE_AUTH=true`, TripIntel runs in guest mode and no sign-in is required.
